...
const enProducts: Product[] = [
  {
    ...
    price: 12.99,
    weight: 0.3,
    image: PRODUCT_IMAGES['dry-chalk/dry-chalk'],
    images: [PRODUCT_IMAGES['dry-chalk/dry-chalk'], PRODUCT_IMAGES['wet-chalk/dry-chalk'], PRODUCT_IMAGES['liquid-chalk/dry-chalk']],
  },
  {
    id: '2',
    slug: '2',
    ...
    price: 13.99,
    weight: 0.3,
    image: PRODUCT_IMAGES['wet-chalk/dry-chalk'],
    images: [PRODUCT_IMAGES['wet-chalk/dry-chalk']],
  },
  {
    id: '3',
    slug: '3',
    ...
    price: 14.99,
    weight: 0.3,
    image: PRODUCT_IMAGES['liquid-chalk/dry-chalk'],
    images: [PRODUCT_IMAGES['liquid-chalk/dry-chalk']],
  },
  {
    id: '4',
    slug: '4',
    ...
    price: 29.99,
    weight: 0.25,
    image: PRODUCT_IMAGES['tshirt/tshirt'],
    images: [PRODUCT_IMAGES['tshirt/tshirt']],
  },
  {
    id: '5',
    slug: '5',
    ...
    kind: [
      { name: 'blue', image: PRODUCT_IMAGES['beanies/blue'], inStock: true },
      { name: 'black', image: PRODUCT_IMAGES['beanies/black'], inStock: true },
      { name: 'red', image: PRODUCT_IMAGES['beanies/red'], inStock: true },
      { name: 'green', image: PRODUCT_IMAGES['beanies/green'], inStock: true },
      { name: 'gray', image: PRODUCT_IMAGES['beanies/gray'], inStock: true },
    ],
    kindTitle: 'Select color:',
    price: 24.99,
    weight: 0.1,
    image: PRODUCT_IMAGES['beanies/blue'],
    images: [PRODUCT_IMAGES['beanies/blue']],
  },
  {
    id: '6',
    slug: '6',
    ...
    kind: [
      { name: 'green', image: PRODUCT_IMAGES['tape/green'], inStock: true },
      { name: 'blue', image: PRODUCT_IMAGES['tape/blue'], inStock: true },
      { name: 'yellow', image: PRODUCT_IMAGES['tape/yellow'], inStock: true },
      { name: 'orange', image: PRODUCT_IMAGES['tape/orange'], inStock: true },
      { name: 'pink', image: PRODUCT_IMAGES['tape/pink'], inStock: true },
      { name: 'black', image: PRODUCT_IMAGES['tape/black'], inStock: true },
      { name: 'white', image: PRODUCT_IMAGES['tape/white'], inStock: true },
    ],
    kindTitle: 'Select color:',
    price: 7.99,
    weight: 0.05,
    image: PRODUCT_IMAGES['tape/green'],
    images: [PRODUCT_IMAGES['tape/green']],
  },
]
...
const bgProducts: Product[] = [
  ...
  },
  {
    ...
    kind: [
      { name: 'син', image: PRODUCT_IMAGES['beanies/blue'], inStock: true },
      { name: 'черен', image: PRODUCT_IMAGES['beanies/black'], inStock: true },
      { name: 'червен', image: PRODUCT_IMAGES['beanies/red'], inStock: true },
      { name: 'зелен', image: PRODUCT_IMAGES['beanies/green'], inStock: true },
      { name: 'сив', image: PRODUCT_IMAGES['beanies/gray'], inStock: true },
    ],
  ...
  },
  {
    ...
    kind: [
      { name: 'зелен', image: PRODUCT_IMAGES['tape/green'], inStock: true },
      { name: 'син', image: PRODUCT_IMAGES['tape/blue'], inStock: true },
      { name: 'жълт', image: PRODUCT_IMAGES['tape/yellow'], inStock: true },
      { name: 'оранжев', image: PRODUCT_IMAGES['tape/orange'], inStock: true },
      { name: 'розов', image: PRODUCT_IMAGES['tape/pink'], inStock: true },
      { name: 'черен', image: PRODUCT_IMAGES['tape/black'], inStock: true },
      { name: 'бял', image: PRODUCT_IMAGES['tape/white'], inStock: true },
    ],
    kindTitle: 'Изберете цвят:',
    price: 7.99,
    weight: 0.05,
